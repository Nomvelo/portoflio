...
function replaceIt() {
    ...
    var pronoun ="<span class ='replacement '>"+ document.getElementById("pronoun").value  +"</span>";
    ...
    theStory += exclamation + "! he exclaimed, as he " + pastVerb2 + " down the stairs to join the " + verb + " i like cake " + adjDance + " party.<br><br>";
    theStory += "Douglas danced the " + animal + " Dance, the " + city + " Shake, and took the prize for dancing the best Electric " + noun + ".<br><br>";
    theStory += "I take " + adverb + " chlidren " + pronoun + "<br><br>";
